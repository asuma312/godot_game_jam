...
var equipped = {
	"head":preload("res://obj/equipments/head/jupiter.tscn").instantiate(),
	"l_arm":preload("res://obj/equipments/arm/l_jupiter.tscn").instantiate(),
	"l_leg":preload("res://obj/equipments/leg/l_jupiter.tscn").instantiate(),
	"armor":preload("res://obj/equipments/armor/jupiter.tscn").instantiate(),
	"r_arm":preload("res://obj/equipments/arm/r_jupiter.tscn").instantiate(),
	"r_leg":preload("res://obj/equipments/leg/r_jupiter.tscn").instantiate()
}
