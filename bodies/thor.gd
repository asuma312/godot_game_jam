...
var equipped = {
	"head":preload("res://obj/equipments/head/thor.tscn").instantiate(),
	"l_arm":preload("res://obj/equipments/arm/l_thor.tscn").instantiate(),
	"l_leg":preload("res://obj/equipments/leg/l_thor.tscn").instantiate(),
	"armor":preload("res://obj/equipments/armor/thor.tscn").instantiate(),
	"r_arm":preload("res://obj/equipments/arm/r_thor.tscn").instantiate(),
	"r_leg":preload("res://obj/equipments/leg/r_thor.tscn").instantiate()
}
